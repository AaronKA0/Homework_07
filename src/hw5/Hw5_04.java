...
public class Hw5_04 {
	...
	public static void main(String[] args) {
		...
		MyRectangle mr1 = new MyRectangle();	//建立MyRectangle物件
		mr1.setWidth(10);						//代入引數10設定width
		mr1.setDepth(20);						//代入引數20設定depth
		System.out.println(mr1.getArea());		//印出getArea return的值
		
		MyRectangle mr2 = new MyRectangle(10, 20);	//建立MyRectangle物件，直接代入引數10,20，傳入建構子
		System.out.println(mr2.getArea());			//印出getArea return的值
	}
}
